...
def _save_articles(news_site_uid,articles):
    ...
    out_file_name = '{new_site_uid}_{datetime}_articles.csv'.format(
        new_site_uid=news_site_uid,
        datetime=now
    )
...
def _fetch_article(news_site_uid,host,link):
    ...
    article = None
    try:
        article = news.ArticlePage(news_site_uid,_built_link(host,link))
